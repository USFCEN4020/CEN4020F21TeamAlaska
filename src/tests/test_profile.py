...
def data():
    ...
    db.execute('''INSERT INTO profile VALUES (?,?,?,?,?,?)''', [p.username, p.title, p.major, p.university_name, p.about_me, p.education])
    yield data
...
def test_set_title(data):
    ...
    updated_title = data['db'].execute('''SELECT title FROM profile WHERE username = ?''', [p.username])
    match = (
...
def test_set_major(data):
    ...
    updated_title = data['db'].execute('''SELECT major FROM profile WHERE username = ?''', [p.username])
    match = (
...
def test_set_university_name(data):
    ...
    updated_title = data['db'].execute('''SELECT university_name FROM profile WHERE username = ?''', [p.username])
    match = (
...
def test_set_about_me(data):
    ...
    updated_title = data['db'].execute('''SELECT about_me FROM profile WHERE username = ?''', [p.username])
    match = (
...
def test_set_education(data):
    ...
    updated_title = data['db'].execute('''SELECT education FROM profile WHERE username = ?''', [p.username])
    match = (
